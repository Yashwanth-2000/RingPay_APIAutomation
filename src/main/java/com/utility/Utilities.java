...
public class Utilities extends ExtentReporter {
	...
	public static ValidatableResponse Get_Details_VPA_API(Object[][] data) throws IOException {
		...
		// response.extract().body().jsonPath().get("data.data.merchant_reference_number");
		// System.out.println("Merchant_Reference_Number : "+merchant_Reference_Number);
		String merchant_Reference_Number = response.extract().body().jsonPath()
				.get("data.merchant_details.merchant_reference_number");
		System.out.println("Merchant_Reference_Number : " + merchant_Reference_Number);
	...
	public static ValidatableResponse userTokenAPI(Object[][] data) throws IOException {
		...
		// String user_token=
		// response.extract().body().jsonPath().get("data.user_token");
	...
	public static ValidatableResponse ValidateAPI(Object[][] data) throws Exception {
		...
		ValidatableResponse mockUserResponse= RegisterUser_Mock_User.mock_User_200();
