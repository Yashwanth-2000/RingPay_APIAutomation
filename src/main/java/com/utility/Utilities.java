...
public class Utilities extends ExtentReporter{
	...
	public static ValidatableResponse SendOtpAPI(Object[][] data) throws IOException {
	...
	public static ValidatableResponse postMethodAPI(HashMap<String, Object> headers,JSONObject Myrequestbody,String url) throws IOException {
	...
	public static ValidatableResponse getMethodWithHeaderAPI(HashMap<String, Object> headers,String url) throws IOException {
	...
	public static ValidatableResponse patchMethodAPI(HashMap<String, Object> headers,JSONObject Myrequestbody,String url) throws IOException {
	...
	public static ValidatableResponse OnloadAPI() throws IOException {
	...
	public static ValidatableResponse Get_Details_VPA_API(Object[][] data) throws IOException {
		...
		System.out.println("Request :"+Myrequestqueryparam);
		...
		//		String merchant_Reference_Number= response.extract().body().jsonPath().get("data.data.merchant_reference_number");
	...
	public static ValidatableResponse userTokenAPI(Object[][] data) throws IOException {
		...
		//		String user_token= response.extract().body().jsonPath().get("data.user_token");
	...
	public static ValidatableResponse RegisterUserAPI(Object[][] data) throws Exception {
		...
		//		ValidatableResponse updateUserResponse=RegisterUser_UpdateUser.updateUser_Positive();
		//		System.out.println("updateUser_Positive :"+updateUserResponse);
		//
		//		String userToken= updateUserResponse.extract().body().jsonPath().get("data.user_token");
		...
		System.out.println("Global_Device_id: "+ global_device_id);
	...
	public static ValidatableResponse Get_User_DetailsAPI() throws Exception {
		...
		headers.put("x-request-id", rand.nextInt(1001));
		headers.put("Authorization", "Bearer "+user_token);
		//		headers.put("Authorization", "client_id=MCUMMlBD7gs98HlHL3Py9Syk3xRsvvU5,token="+UserToken);
